...
To propose a change to this component, first [open an issue](https://github.com/karavel-io/platform-component-olm/issues/new)
...
Finally [open a pull request](https://github.com/karavel-io/platform-component-olm/compare/main) from your fork to the `main`
