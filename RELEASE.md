...
by running `git tag X.Y.0` on that branch. A [CI job](https://github.com/projectkaravel/platform-component-olm/actions/workflows/release.yml) 
will kick in, packaging the component and creating the corresponding [release](https://github.com/projectkaravel/platform-component-olm/releases).
